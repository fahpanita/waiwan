...
const SetCaiXingYea = () => {
  ...
  const handleDownload = () => {
    ...
    link.href = "/image/img/SetCaiXingYea.png";

    link.download = "SetCaiXingYea.png";
    ...
    <>
      <Layout>
        ...
        <Content style={{ padding: "0 32px" }}>
          ...
          <div
            style={{
              backgroundImage: `url("https://i.ibb.co/zJ5JhDt/image.png")`,
            ...
            >
              <DropZone>
                <div style={{ marginBottom: "10px" }}>
                  ...
                  >
                    <a style={{ color: "#fff" }}>น้ำชา 5 ที่</a>
                  </DropBox>
                </div>
              </DropZone>
              ...
              <DropZone>
                <div style={{ marginBottom: "20px" }}>
                  <DropBox2
                    ...
                    onDragOver={allowDrop}
                  >
                    <a style={{ color: "#fff" }}>ข้าว 5 ที่</a>
                  </DropBox2>
                </div>
              </DropZone>
              ...
              <DropZone>
                ...
                >
                  <DropBox5
                    ...
                    onDragOver={allowDrop}
                  >
                    <a style={{ color: "#fff", textAlign: "center" }}>
                      กระดาษเงิน/ทอง
                    </a>
                  </DropBox5>
                  <DropBox3
                    onDrop={(event) => drop(event, "bualoiBox")}
                    onDragOver={allowDrop}
                    style={{ margin: "0 25px" }}
                  >
                    <a style={{ color: "#fff", textAlign: "center" }}>
              ...
              <DropZone>
                ...
                >
                  <DropBox5
                    ...
                    onDragOver={allowDrop}
                  >
                    <a style={{ color: "#fff", textAlign: "center" }}>ผลไม้</a>
                  </DropBox5>
                  <DropBox5
                    onDrop={(event) => drop(event, "junaubBox")}
                    onDragOver={allowDrop}
                  ...
                  <DropBox5
                    onDrop={(event) => drop(event, "jshyBox")}
                    onDragOver={allowDrop}
                  >
                    <a style={{ color: "#fff", textAlign: "center" }}>เจฉ่าย</a>
                  </DropBox5>
                </div>
              </DropZone>
              ...
              <BoxStyle>
                ...
                <ImageContainer onDrop={drop} onDragOver={allowDrop}>
                  <img
                    id="junaub"
                    targetKey="junaubBox"
                    src="https://i.ibb.co/bQQw7kK/sweet-junaub.png"
                    draggable="true"
                    onDragStart={drag}
                    width="100"
                    style={{ margin: "0 10px" }}
                  ...
                  <img
                    id="jshy"
                    targetKey="jshyBox"
                    src="https://i.ibb.co/SB4T4gs/jshy.png"
                    draggable="true"
                    onDragStart={drag}
                    width="100"
                    style={{ margin: "0 10px" }}
                  ...
                  <img
                    id="rice-group"
                    targetKey="riceBox"
                    src="https://i.ibb.co/wJJkCJR/rice-group.png"
                    draggable="true"
                    onDragStart={drag}
                    width="230"
                    style={{ margin: "0 10px" }}
                  ...
                  <img
                    id="paper-god-2"
                    targetKey="paperBox"
                    src="https://i.ibb.co/DYSSWrM/paper-god-2.png"
                    draggable="true"
                    onDragStart={drag}
                    width="100"
                    style={{ margin: "0 10px" }}
                  ...
                  <img
                    id="bualoi-group"
                    targetKey="bualoiBox"
                    src="https://i.ibb.co/V2mtc7n/bualoi-group.png"
                    draggable="true"
                    onDragStart={drag}
                    width="280"
                    style={{ margin: "0 10px" }}
          ...
          >
            ...
            >
              ...
              <Col style={{ marginTop: "20px" }}>
                ...
                >
                  หากต้องการซื้อสินค้าชุดไหว้เจ้าวันไฉ่ซิงเอี๊ยชุดนี้กดปุ่มด้านล่างนี้
                </p>
              </Col>
            </Row>
          </Modal>
