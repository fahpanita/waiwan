...
const SetChineseYear = () => {
  ...
  const handleDownload = () => {
    ...
    link.href = "/image/img/SetChineseYear.png";

    link.download = "SetChineseYear.png";
    ...
    <>
      <Layout>
        ...
        <Content style={{ padding: "0 32px" }}>
          ...
          <div
            style={{
              backgroundImage: `url("https://i.ibb.co/cYMPfBw/image.png")`,
