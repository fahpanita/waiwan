...
const items = [
    getItem(<Link to="/dashboard" style={{ textDecoration: 'none' }}>รายงานการขาย</Link>, 'Dashboard', <AppstoreOutlined />),
    getItem(<Link to="/seller" style={{ textDecoration: 'none' }}>รายการคำสั่งซื้อ</Link>, 'seller', <ShoppingCartOutlined />),
